...
getInnerHeight: function(navBarPresent) {
	...
	var tmpHeight =  this.getInnerTileHeight(navBarPresent) - 8;
...
// parameters below this are internally manupulated - no need to set them
wdgt_color: '#FFFFFF',
brdr_margin_top: 10,
...
style_wdgt_hd: function() {
	var paddingBottom = "";
	if(this.isIAB){
		paddingBottom = "padding-bottom:4px;padding-top:4px;";
	}
	return paddingBottom + 'text-align: left;font: bold 12px / 1em Verdana, Arial, Helvetica, sans-serif;color: ' + this.head_text_color +';';
},
style_wdgt_brdr: function(borderWidth) {
    return 'background: ' + this.inner_bkgd_color
