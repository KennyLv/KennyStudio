<?php
    ...
    {
        "yearFrom": "2008.8~2010.8",
        "yearTo": "",
        "companyName": "Infoition",
        "jobTitle": "Product Marketing Manager",
        "description": "Planning and developmesdcfsddfvfdvdfgvdfgfdgdgdsgsdgdgdgergbgdvaserwefdfvcsdewrnt included market research, competitor analysis, pricing strategies, messaging, prod"
    },
    {
        "yearFrom": "",
        "yearTo": "",
    ...
    },
    {
        ...
        "university": "University of Central Florida"
				...
				case "skills" :
					$resopnse = json_decode( '{
								"Ç°¶Ë¿ª·¢": {".NET":"ASP.NET","Javascript": ["Nodejs","AngualrJs","Backbone","Canjs","RequireJs","","",""], "css" : ["css3","LESS"], "HTML5":[]},
